  ...
  try{
    if(req.method==="POST"){
      ...
      for(const n of numeros){
        if(n.numero===undefined||n.numero<0||n.numero_matrizes<=0||n.saldo_giros_inicial<0){
      ...
      return res.status(200).json({ message: "Programa cadastrado com sucesso!" });
    }
      ...
      return res.status(200).json(programasData);
    }
    else{
